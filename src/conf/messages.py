...
SETTINGS_ALREADY_EXIST = "Settings already exist"
SESSION_NOT_FOUND = "Session not found"
SESSION_NOT_CLOSED = "Session is not closed"
PAYMENT_FOR_SESSION_EXISTS= "Payment for this session already exists"
